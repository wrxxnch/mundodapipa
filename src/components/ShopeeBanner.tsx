    ...
    <div className="bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-white rounded-3xl p-6 sm:p-8 my-8 card-shadow relative overflow-hidden border-2 border-orange-500/60">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          <div className="hidden sm:block w-20 h-20 rounded-full overflow-hidden border-2 border-amber-400 shadow-lg shrink-0 bg-slate-900 p-1 flex items-center justify-center">
            <img src={logoImg} alt="Mundo da Pipa Oficial" className="w-full h-full object-contain" referrerPolicy="no-referrer" />
          </div>
